...
export default function Page() {
    ...
    if (appState === "home") {
        return (
            <>
                <BackgroundMusic appState={appState} />
        ...
        const storyLines = [
            ...
            },
            {
                ...
                vi: (
                    <>
                        Với tư cách là{" "}
                        <span className="text-sky-400 font-bold">Tân Thị trưởng</span>, nhiệm vụ của
                        bạn là đưa ra những quyết định khó khăn để thay đổi số phận của nơi này.
                    </>
                ),
                en: (
                    <>
                        As the <span className="text-sky-400 font-bold">New Mayor</span>, your
                        mission is to make tough decisions to change the fate of this place.
                    </>
                ),
            },
            {
    ...
    const netScore =
        (resultChanges.energy || 0) +
        (resultChanges.environment || 0) +
        (resultChanges.budget || 0) +
        (resultChanges.trust || 0);
