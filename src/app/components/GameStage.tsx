            ...
            <div className="max-w-5xl w-full flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 pb-10">
                ...
                >
                    ...
                    <p className="text-slate-600 text-lg md:text-xl font-medium leading-relaxed mb-8">
                        &ldquo;Mayor! The local logging companies are clear-cutting the{" "}
                        <span className="font-bold text-slate-800">Whispering Woods</span> at an
                        alarming rate. Our environment score is dropping rapidly, but they bring in
                        heavy tax revenue. How should we proceed?&rdquo;
                    </p>
